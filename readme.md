...
<!--THIS FILE: Copyright © All Rights Reserved by zer0Kerbal-->

[![MEV Heavy Industries][MOD:shd:latest]][MOD:forum]  
...
<img src="https://raw.githubusercontent.com/zer0Kerbal/MEVHeavyIndustries/master/img/HeroLogo_1920x1920.png" alt="MEVHeavyIndustries Hero" width="50%" height="50%">

### Preamble by [Cyne][cyne]
>
...
[![KSP Mods - MEV Heavy Industries](https://img.youtube.com/vi/WbkVRbZsqGI/0.jpg)](https://www.youtube.com/watch?v=WbkVRbZsqGI)
...
I take no part, nor am I interested in maintaining the [CKAN][ckan:url] mod metadata for my mods. [CKAN][ckan:url] is a great mod for those that can't use zip tools. If you are having issues please let the [CKAN][ckan:url] people know and refer to the [CKAN][ckan:url] thread. Beware, [CKAN][ckan:url] *can* really mess up though it tries very, very, very hard not to.
...
* Either
  ...
  * [Module Manager][mm]
* [KSP Interstellar Extended (KSPIE)][kspie]
* [Interstellar Fuel Switch (Core)][ifsc] or [Interstellar Fuel Switch][ifs]
* [TweakScale (TWK)][twk]
* Community Tech Tree

### Credits and Special Thanks

* [Cyne][cyne] for creating this glorious parts addon!
...
> License:
  ...
  > Distrubution only permitted through authorized Curseforge/Overwolf listing.
>
> ##### Disclaimer(s)
>
...
<!-- mod links -->
[MOD:attr]: https://zer0kerbal.github.io/MEVHeavyIndustries/Attributions "Attribution"
...
<!--- mod -->
[MOD:shd:latest]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/MEVHeavyIndustries/master/json/mod.json
...
<!--- release links -->
[CURSFG:url]: https://www.curseforge.com/kerbal/ksp-mods/MEVHeavyIndustries "Curseforge"
...
[zer0Kerbal]: https://github.com/zer0Kerbal "zer0Kerbal"
[lisias]: https://github.com/Lisias "Lisias"